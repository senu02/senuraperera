...
const CircleWrapper = ({
  ...
  >
    ...
    >
      <circle opacity="0.3" cx="27.5" cy="27.5" r="27" stroke="#ffffff" />
    </svg>
              ...
              {group.items.map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
                    onClick={onClose}
                    className="text--18 text-white transition-colors duration-200 leading-snug pl--40"
                  >
                    {item.label}
                  </Link>
                </li>
        ...
        <>
          ...
          >
            <div className="flex flex-col min-h-full">
              ...
              <nav className="flex flex-col text-center text-white flex-1 px--40 py--20">
                {navGroups.map((group) => (
                  <AccordionItem
                    key={group.label}
                    group={group}
              ...
              <div className="flex items-center justify-center space--15 py--40">
                <CircleWrapper href="https://www.facebook.com/dulaj.perera.355?mibextid=wwXIfr&mibextid=wwXIfr">
                  <FacebookIcon />
                </CircleWrapper>
                ...
                <CircleWrapper href="https://www.linkedin.com/in/senura-perera-21b26b33a/">
                  <LinkedinIcon />
                </CircleWrapper>
